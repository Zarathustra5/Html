...
let path = {
  ...
  //Пути ввода файлов, файлы, которые Galp должен обработать
  src:{
...
let build = gulp.series(clean, swiper, gulp.parallel(js, css, html, images, fonts), fontsStyle);
